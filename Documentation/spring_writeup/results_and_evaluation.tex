...
This section sets out to examine the provided library and how its use
...
The first notable difference between D and Ada is that the syntax of the two languages 
is significantly different: D follows a C style approach, using curly braces to indicate scope,
