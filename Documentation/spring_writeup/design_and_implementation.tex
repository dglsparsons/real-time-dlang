...
to the outermost section. This occurs because the exception would be caught and
...
\end{lstlisting}
This example enables both the use of exceptions within the ATC region, and
